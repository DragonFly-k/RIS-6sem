...
struct SETSINCRO{string cmd; int correction;};
...
//считает среднюю коррекцию по значениям из массива и его длине
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	try
	{
		...
		while (count !=11)
		{
			...
			//correction =  Cs- curvalue - вычисление коррекции
			setsincro.correction = c - getsincro.correction;
			//добавление коррекции в массив для посчета средней
